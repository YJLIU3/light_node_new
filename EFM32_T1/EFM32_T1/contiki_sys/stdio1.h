 ...
 */
			extern _ARMABI int setvbuf(FILE * __restrict /*stream*/,
				char * __restrict /*buf*/,
				int /*mode*/,
				size_t /*size*/) __attribute__((__nonnull__(1)));
/*
 ...
 #pragma __printf_args
			...
			extern _ARMABI int _sprintf(char * __restrict /*s*/, const char * __restrict /*format*/, ...) __attribute__((__nonnull__(1, 2)));
			    ...
			    */
			    ...
			    #pragma __printf_args
			extern _ARMABI int snprintf(char * __restrict /*s*/,
				size_t /*n*/,
				const char * __restrict /*format*/,
 ...
 */
 #endif
 #pragma __printf_args
			extern _ARMABI int _snprintf(char * __restrict /*s*/,
				size_t /*n*/,
				const char * __restrict /*format*/,
				...) __attribute__((__nonnull__(3)));
/*
 ...
 */
 ...
 /* C99 additions */
			...
			extern _ARMABI int vfprintf(FILE * __restrict /*stream*/,
				const char * __restrict /*format*/,
				__va_list /*arg*/) __attribute__((__nonnull__(1, 2)));
/*
 ...
 */
 #if !defined(__STRICT_ANSI__) || (defined(__STDC_VERSION__) && 199901L <= __STDC_VERSION__)
			extern _ARMABI int vsnprintf(char * __restrict /*s*/,
				size_t /*n*/,
				const char * __restrict /*format*/,
				__va_list /*arg*/) __attribute__((__nonnull__(3)));
/*
 ...
 * Returns: as vfprintf.
 */
			extern _ARMABI int _vsnprintf(char * __restrict /*s*/,
				size_t /*n*/,
				const char * __restrict /*format*/,
				__va_list /*arg*/) __attribute__((__nonnull__(3)));
/*
 ...
 */
			extern _ARMABI int fgetc(FILE * /*stream*/) __attribute__((__nonnull__(1)));
			    ...
			    */
			extern _ARMABI char *fgets(char * __restrict /*s*/,
				int /*n*/,
 ...
 */
			...
			extern _ARMABI size_t fread(void * __restrict /*ptr*/,
				size_t /*size*/,
				size_t /*nmemb*/,
				FILE * __restrict /*stream*/) __attribute__((__nonnull__(1, 4)));
/*
