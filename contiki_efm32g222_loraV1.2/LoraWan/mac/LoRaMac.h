 ...
 */
#define RECEIVE_DELAY1                              CLOCK_CONF_SECOND*1

/*!
 * Class A&B receive delay 2 in ms
 */
#define RECEIVE_DELAY2                              CLOCK_CONF_SECOND*3

/*!
 * Join accept receive delay 1 in ms
 */
#define JOIN_ACCEPT_DELAY1                          CLOCK_CONF_SECOND*9+100
/*!
 * Join accept receive delay 2 in ms
 */
#define JOIN_ACCEPT_DELAY2                          CLOCK_CONF_SECOND*11

/*!
 * Class A&B maximum receive window delay in ms
 */
#define MAX_RX_WINDOW                               CLOCK_CONF_SECOND*3
 ...
 */
#define ACK_TIMEOUT                                 CLOCK_CONF_SECOND*2
 ...
 * AckTimeout = \ref ACK_TIMEOUT + Random( -\ref ACK_TIMEOUT_RND, \ref ACK_TIMEOUT_RND )
 */
#define ACK_TIMEOUT_RND                             CLOCK_CONF_SECOND

/*!
 * Check the Mac layer state every MAC_STATE_CHECK_TIMEOUT in ms
 */
#define MAC_STATE_CHECK_TIMEOUT                     CLOCK_CONF_SECOND*1
