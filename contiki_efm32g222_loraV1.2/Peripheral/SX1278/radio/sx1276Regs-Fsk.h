...
#define RF_OPMODE_LONGRANGEMODE_OFF                 0x00  //FSK模式
#define RF_OPMODE_LONGRANGEMODE_ON                  0x80  //LORA模式
...
#define RF_OPMODE_SLEEP                             0x00   //睡眠模式
#define RF_OPMODE_STANDBY                           0x01   //Default  待机模式
#define RF_OPMODE_SYNTHESIZER_TX                    0x02   //频率合成发送( FSTx) 
#define RF_OPMODE_TRANSMITTER                       0x03   //TX模式
#define RF_OPMODE_SYNTHESIZER_RX                    0x04   //频率合成接收( FSRx) 
#define RF_OPMODE_RECEIVER                          0x05   //连续接收
...
#define RF_PACONFIG_PASELECT_PABOOST                0x80  //PA_BOOST 最大功率+20dBm
#define RF_PACONFIG_PASELECT_RFO                    0x00 // Default  最大功率+14dBm 
