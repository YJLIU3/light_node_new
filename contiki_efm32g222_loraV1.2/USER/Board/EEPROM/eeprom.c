...
uint8_t Relay_Add[2]={0x00,0x00};  //ÖÐ¼ÌµØÖ·

/* Define the non-volatile variables. */
EE_Variable_TypeDef var1, var2, var3, var4;
...
///* Write to var1. */
//   EE_Write(&var1, ((uint16_t)(Relay_Add[0]<<8))|((uint16_t)Relay_Add[1]));
  ...
  EE_Read(&var1, &readValue);	
	Relay_Add[0]=readValue>>8;
	Relay_Add[1]=readValue&0x00ff;
	
//	Leusart_Txdata(Relay_Add,2);
